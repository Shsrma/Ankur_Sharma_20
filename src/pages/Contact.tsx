      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="glass-card p-8">
              ...
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground mb-4">
                  Select a topic to start a conversation with a pre-filled message:
                </p>
                ...
                <motion.a
                  href="mailto:ankurbpradhan@outlook.com?subject=Project%20Collaboration%20Idea&body=Hi%20Ankur,%0D%0A%0D%0AI%20have%20an%20exciting%20project%20idea%20I'd%20like%20to%20discuss%20with%20you.%0D%0A%0D%0ADetails:%0D%0A"
                  className="block w-full p-4 rounded-xl border border-purple-500/20 bg-purple-500/10 hover:bg-purple-500/20 transition-all cursor-pointer"
                  whileHover={{ scale: 1.02 }}
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-purple-500">Project Collaboration</div>
                      <div className="text-xs text-muted-foreground">"I have a project idea to discuss..."</div>
                    </div>
                  </div>
                </motion.a>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-blue-500">General Inquiry</div>
            ...
            {/* Direct Contact (Kept for completeness if desired, or can be removed if redundant) */}
            <div className="glass-card p-8">
